...
int main(int argc, char** argv)
{
    ...
    sf::RenderWindow window(sf::VideoMode(1280, 720), "Game Client");
	...
	freopen("ClientLog.txt","w", stdout);    
	g_clientGame = new Game_C();
    g_clientGame->Init();
    ...
    while (window.isOpen())
    {
        ...
        while (accumulatedTime>=UPDATE_INTERVAL)
        {
            ...
            g_clientGame->Update(UPDATE_INTERVAL);
            commandFrame++;
        }
		g_clientGame->Draw(&window);
    }
